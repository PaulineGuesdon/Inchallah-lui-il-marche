...
\subsection{Apparatus on scattering theory}
...
The Franck Condon factor (\cite{guttridge_photoassociation_2019})
is the probability to transition from an initial vibrational $i$ state to 
