...
By reflexion with the left barrier of the potential at $x=x_1$ the stationnary wave must come back with a $2\pi$ at 
$x_2$. By continuity of the solutions in $[0, +\infty[$ the phase tends to
\begin{equation}
    \int_{x_1}^{x_2} k(x)dx = (n+\frac{1}{2})\pi 
\end{equation}

Then this formula enables to identify the position of the vibrationnal states of the molecular potential by solving
it for $E=V(x)$
