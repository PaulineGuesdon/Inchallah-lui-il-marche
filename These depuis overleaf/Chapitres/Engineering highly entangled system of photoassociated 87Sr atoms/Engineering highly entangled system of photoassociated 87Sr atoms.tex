...
Around $80$ lines were measured without being identified to the associated molecular potential.
Atom loss spectra as a function of PA laser detuning reveal the position of the bound states 
...
\subsection{Protocol}
To induce Dicke state through PA process resulting in a high dimension 
Dicke states of N atoms of antisymetric spin wavefuncton.\\

The aim is to induce Dicke state on a gas of fermions with a precision that goes beyond quantum 
shot-noise limit. Two-body losses on ultracold trapped atoms in the ground state will result in 


In a first time we did calibrated our spectroscopic method on isotope $^{88}Sr$.
