...
It also means that the phase $\delta_l$ of the free state 
wavefunction is modified by this coupling same as for the scattering
length. The real part of $a$ encodes two-body losses rate 
whereas its imaginary part changes the collisions properties.\\ 
...
This quantity rates the decay of the number of atoms in time as
