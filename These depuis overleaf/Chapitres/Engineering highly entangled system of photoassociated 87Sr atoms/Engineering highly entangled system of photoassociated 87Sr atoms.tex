...
evolution of the system because of the lifetime $\gamma_{mol}$.\\
This quantity takes a role in the atom number decay rate that evolves as
...
\begin{equation}
    ...
    \label{elastic evolution equation}
\end{equation}\\
The eigenvector of the ground state $\psi_g$ is then modified by this coupling.
