...
A semi-classical approach enables to find the eigenvectors of atoms in a molecular potential.
We separate the interaction zones considering the condition $\frac{1}{2\pi}|\frac{d\lambda}{dx}|\ll 1$
...
to adapt their movement to its variation. It means at really small $x$ of region 1 \ref{fig:pa-sakurai-wkb} 
...
Leroy-Bernstein theory enables to identify the position of the less bounded states close to
the dissociation limit occuring at long distance. Then the potential express as
\begin{equation}
...
\begin{equation}
    E_\nu = \left(\frac{\sqrt{\pi}}{\sqrt{2}\mu}\frac{\hbar(\nu-2)}{C_n^{1/n}}\frac{\Gamma(1+\frac{1}{\nu})}{\Gamma(\frac{1}{2}+\frac{1}{\nu})} \right)^\frac{2\nu}{\nu-2}
\end{equation}
which also writes as
\begin{equation}
    \frac{E_\nu - D_e}{\nu_D - \nu} = \left(\frac{\sqrt{\pi}}{\sqrt{2}\mu}\frac{\hbar(\nu-2)}{C_n^{1/n}}\frac{\Gamma(1+\frac{1}{\nu})}{\Gamma(\frac{1}{2}+\frac{1}{\nu})} \right)^\frac{2\nu}{\nu-2}
\end{equation}
We find there that we can determine the energy difference between the dissociation limit and
a the least bounded states of the molecule. 
