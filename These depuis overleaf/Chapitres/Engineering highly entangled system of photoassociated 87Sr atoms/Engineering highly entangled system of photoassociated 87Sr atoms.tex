...
state. We will focus on this section in this state to simplify the discussion.\\
...
For the rotationnal quantum number there is a parity of the total wavefunction that needs to 
...
and $\ket{\chi}$ is the spin wavefunction.
...
related momentum to the internuclear axis, quantified by $\Omega$ and described as Hund's case (c)\\
\begin{figure}[H]
    \centering
