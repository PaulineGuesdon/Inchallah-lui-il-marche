...
which also means that the atoms spend the most time at this position.\\


The good quantum numbers :\\
We write the total angular momentum of the molecule $T = R + F = R + I + J$, $F$ being the 
total spin of the two atoms $f_1 + f_2$, and R the rotational angular momentum of the molecule. The R =0
in our case because we have only s-wave collisions.\\

$M_T$ is the projection of T on the quantization axis being the internuclear axis.\\
...
or $2$. The nuclear spin being $I = 9/2$ for each atom, we can have a total nuclear spin of $I = 0, 1, 2, 3, 4, 5, 6, 7, 
8$ or $9$. So we have final possibles values of 

We have one atom with $f_1=9/2$ from the $^1S_0$ state and one in the $^3P_1$ state with possible values $f_2=11/2$.
The final values of total angular momentum of the molecule are $F = 1, 2, 3, 4, 5, 6, 7, 8, 9$ or $10$.
