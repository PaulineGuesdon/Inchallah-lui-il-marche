...
Adding a resonant laser at frequency $\Omega$ couples a closed channel $\ket{g,g}$ to a
virtual channel $\ket{g,e}$ changing the shape of the
ground potential $V_g$ (by e.g by Zeeman coupling, Stark...). 
It also means that the phase 
$\delta_l$ is modified by the coupling of those
channel without the creation of a bound state and so the scattering
length discribing their elastic interaction. The effective hamiltonian
of this 
