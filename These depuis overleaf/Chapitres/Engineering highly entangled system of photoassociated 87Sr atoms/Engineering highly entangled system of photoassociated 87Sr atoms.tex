...
Optical length is defined as the imaginary part of the scattering length.

and describes the stength of 
the photoassociation rate 
...
\begin{equation} 
    F_{FC} = \Bigg|\int \psi_i^* \psi_f dr\Bigg |^2 
\end{equation}
