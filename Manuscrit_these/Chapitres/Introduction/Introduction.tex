...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Introduction/images/PID_black.png}
    \caption{Extracted from \cite{black_introduction_2001} }
    \label{pid}
\end{figure}
