...
Optical Dipole Trap (ODT) operating at $1075~\text{nm}$, followed by forced evaporative
cooling.
...
The $1075~\text{nm}$ light from the IPG laser is split by a half-wave plate and
...
\begin{figure}[H]
    ...
    \caption{Optical setup of the $1075~\text{nm}$ crossed dipole trap laser system.}
    \label{fig:odt}
\end{figure}
