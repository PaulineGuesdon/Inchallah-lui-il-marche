...
\end{equation}
The laser frequency is swept across 200~kHz the targeted $^3P_1, F = 11/2, m_F'$ sub-levels to deplete specific ground-state populations in $^1S_0, F=9/2, m_F$, during about 10~$\mu$s with intensity $\simeq 70I_{sat}$. Governed by electric dipole selection rules ($\Delta m_F = 0, \pm 1$), spontaneous emission redistributes the excited atoms into adjacent lower ground-state sub-levels, resulting in a progressive accumulation in the target spin states.
...
\subsection{Repair of the MOGlabs}
\hl{parler des pièces changées et de stabilisation en l'éteignant et retouchant le seuil avec ajout de fibres pour alignement}
