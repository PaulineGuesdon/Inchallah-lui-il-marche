% !TeX root = ../../main.tex
\begin{flushright}
\end{flushright}\chapter{Gas_preparation_and_spin_control}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/energy_levels_sr.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/chaine_bleue_actualisée.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/doppler_shift.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/felix_faisant_these.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/energy_levels_repumper.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/table_repumper.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/chaine_rouge_vieille.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/need_for_stir.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/randomisation.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/red_MOT_in_3_steps.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/ODT_loading.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/evaporative_cooling.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/1.30_dipole_trap(1075)_setup.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/optical_pumping.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth, angle=90]{Chapitres/Gas_preparation_and_spin_control/images/ECDL_laser.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/TLS_et_raman.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/chaine_moglab.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/moglab.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/changestoFPcavity.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/changestoFPcavityAFTER.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/PID_black.png}
...
From this graph, one measures a signal-to-noise ratio of \hl{SNR =}. Interestingly, the sideband resonance features were not distinctly visible on the scanning error signal, even when driving the EOM with a high modulation depth to maximize the $J_1/J_0$ ratio.
 ...
 \begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/signal pdh.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/bruits_amplifies.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas_preparation_and_spin_control/images/spin_kick_scheme.png}
