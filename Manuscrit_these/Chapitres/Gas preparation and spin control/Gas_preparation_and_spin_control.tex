...
Due to anisotropic geometric constraints of our atomic beam, the intensity in the horizontal arm is set roughly three times higher than in the vertical arm, $I/I_{sat} = 0.25$ though both remain below saturation ($I \ll I_{\text{sat}}$) over an interaction area of approximately $10~\text{cm}^2$. The TC laser remains active throughout subsequent blue-cooling stages to ensure continuous atomic flux collimation.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{Chapitres/Gas preparation and spin control/images/energy_levels_repumper.pdf}
...
\begin{figure}[H]
    ...
    \caption{Sequential stages of the $689~\text{nm}$ red MOT. From left to right : swap cooling, broadband capture and single-frequency cooling (adapted from \cite{StellmerThesis}). The size of the cloud is decreasing with the cooling since the atoms are kicked in the opposite direction of the resonant laser of right polarization.}
...
\begin{figure}[H]
    ...
    \caption{MOGlabs External Cavity Diode Laser (ECDL) architecture used for spin manipulation. A diode lasing at 689~nm is frequency settled by an interferential filter to then be collimated by a lens. The beam is focused in the middle of this lens and a second one where the beam is reflected: this system is selecting more precisely the frequency of the laser as a cateye. }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas preparation and spin control/images/cavity_before.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Chapitres/Gas preparation and spin control/images/changestoFPcavityAFTEE.pdf}
    \caption{Upgraded and final cavity mount featuring three adjustment screws and compliant washers for precise angular and longitudinal alignment.}
