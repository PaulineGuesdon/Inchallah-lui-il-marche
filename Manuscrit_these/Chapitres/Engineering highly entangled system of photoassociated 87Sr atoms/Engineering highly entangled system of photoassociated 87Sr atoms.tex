...
\section{Gas preparation and spin control on photoassociation}
\subsection{Scattering theory}
Understanding the PA process necessitates an Gas preparation and spin control to scattering theory to define key quantities such as the scattering length and the optical length. These parameters emerge naturally from the asymptotic analysis of the radial Schrödinger equation describing the relative motion of two colliding atoms.
...
the incident electric field of frequency $f_0$ fixed at $f_M=40.48$ MHz (see \cite{black_Gas preparation and spin control_2001}). The phase modulation gives rise to interferences between the carrier at central frequency 
...
\textbf{Deduced technical width $\Gamma_{\text{laser+rem}}$} [kHz] & $112.58\hl{\pm}$ & $328.99\hl{\pm}$ \\ \hline
\end{tabular}
\end{table}
