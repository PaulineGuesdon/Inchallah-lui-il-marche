...
The first molecular state $f_1 = -259.01\pm 0.12$ red detuned from the atomic resonance has been obtained for illumination time of t = 1000~ms on a 
...
The exponential decay has not been verified for this resonance but the behavior of the temperature testify the molecular creation.
...
The second line detected is at $f_2 = -274.83\pm 0.03$ MHz from the atomic resonance plotted in \ref{subfig:274MHz_spectrum}. The gas prepared of density
...
The analysis of the resonance is completed by the exponential decay observation in \ref{subfig:274MHz_exp}:
\hl{ajouter analyse de cette data et parler d'éventuellement les deux sources de one-body loss}
