...
\begin{align}
\text{For } R=1, &\quad {T = 0, 2, 3... 11}\\
\text{For } R=3, &\quad {T = 2, 3,... 13}\\
\text{For } R=5, &\quad {T = 4, 5, ... 15}
\end{align}
...
\begin{align}
\text{For } R=1, &\quad {T^f = 1, 2, 3... 10}\\
\text{For } R=3, &\quad {T^f = 1,2... 10}\\
\text{For } R=5, &\quad {T^f = 1,2 ... 10}\\
\end{align}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.8\linewidth}
        ...
        \caption{Resonance spectrum at $276.83 \pm 0.03$ MHz ($I = 5.2$ W/cm$^2$).}
