...
\begin{equation}
    K_2 = \frac{8\pi \hbar}{m_p}\times \frac{l_{opt}}{\Delta^2 +\frac{1}{4}(1+2k l_{opt})^2}
    \label{K2 complet}
\end{equation}
...
\frac{dN(t,T)}{dt} = -K_2 \frac{N(t,T)^2}{2\sqrt{2}V_e(T)} = -\beta(T) N(t,T)^2 \label{eq:3.26} \\[1.5ex]
\text{where } V_e(T) = (2\pi)^{3/2} \sigma_x(T) \sigma_y(T) \sigma_z(T) \label{eq:3.27} \\[1.5ex]
\text{Then } \beta(T) = \frac{K_2}{2\sqrt{2}V_e(T)} \label{eq:3.28}
\end{gather}
