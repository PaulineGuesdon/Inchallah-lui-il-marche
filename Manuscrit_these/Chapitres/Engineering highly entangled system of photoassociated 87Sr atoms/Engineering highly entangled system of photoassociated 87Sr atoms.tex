...
\section{Gas_preparation_and_spin_control on photoassociation}
\subsection{Scattering theory}
Understanding the PA process necessitates an Gas_preparation_and_spin_control to scattering theory to define key quantities such as the scattering length and the optical length. These parameters emerge naturally from the asymptotic analysis of the radial Schrödinger equation describing the relative motion of two colliding atoms.
